...
/* diner/index.html */
class __TwigTemplate_627db698bb4d3bdad6591867dc2944d8 extends Template
{
...
<body>
  ";
        ...
        if (($context["show"] ?? null)) {
            // line 20
            yield "  ";
            yield from $this->loadTemplate("/diner/diner-header.html", "diner/index.html", 20)->unwrap()->yield($context);
            // line 21
            yield "  ";
        } else {
            // line 22
            yield "  ";
            yield from $this->loadTemplate("header.html", "diner/index.html", 22)->unwrap()->yield($context);
            // line 23
            yield "  ";
        }
        // line 24
...
<body>
  ...
  <!-- Footer Section to display contact and awards-->
  {{ include('footer.html') }}", "diner/index.html", "/var/www/html/mounted/website/src/Views/diner/index.html");
    }
}
