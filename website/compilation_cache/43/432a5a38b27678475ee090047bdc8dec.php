...
class __TwigTemplate_292c39e8c8de476dd1d00229c93bdd0f extends Template
{
...
<body>
  ...
  ";
        ...
        if (($context["show"] ?? null)) {
            // line 22
            yield "    ";
            yield from $this->loadTemplate("/diner/DinerHubHeader.html", "diner/reservation.html", 22)->unwrap()->yield($context);
            // line 23
            yield "  ";
        } else {
            // line 24
      ...
      <div class=\"reservation-container\">
        ...
        <form>
          ...
          <div class=\"form-group\">
            ...
            <input aria-label=\"Input for Your Email Address\" type=\"email\" id=\"email\" name=\"email\" required>
          </div>
          <!-- label for date -->
          <div class=\"form-group\">
  ...
  ";
    ...
    {
        return array (  163 => 109,  78 => 26,  75 => 25,  72 => 24,  69 => 23,  66 => 22,  64 => 21,  42 => 1,);
    }
...
<body>
  ...
  {% if show %}
    {% include '/diner/DinerHubHeader.html' %}
  {% else %}
    {% include 'header.html' %}
  {% endif %}
...
</html>", "diner/reservation.html", "/var/www/html/mounted/website/src/Views/diner/reservation.html");
    }
}
