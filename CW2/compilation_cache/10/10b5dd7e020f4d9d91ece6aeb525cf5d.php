...
/* staffportal/StaffPortal.html */
class __TwigTemplate_23e7446e2fe392cdf2338d6b919daa78 extends Template
{
...
<head>
    ...
    <title>";
        ...
        yield "</title>
    <link rel=\"stylesheet\" href=\"/public/css/staff/staffportalhub.css\">
</head>
<body>
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["service"]) {
            ...
            yield "            <tr>
                <td>";
            // line 65
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["service"], "name", [], "any", false, false, false, 65), "html", null, true);
            yield "</td>
                <td>";
            // line 66
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["service"], "bookings", [], "any", false, false, false, 66), "html", null, true);
            yield "</td>
                <td>";
            // line 67
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["service"], "time", [], "any", false, false, false, 67), "html", null, true);
            yield "</td>
                <td>";
            // line 68
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["service"], "details", [], "any", false, false, false, 68), "html", null, true);
            yield "</td>
            </tr>
            ";
        }
...
";
    ...
    {
        return "staffportal/StaffPortal.html";
    }
    ...
    {
        return array (  191 => 77,  183 => 71,  174 => 68,  170 => 67,  166 => 66,  162 => 65,  159 => 64,  155 => 63,  132 => 42,  125 => 40,  122 => 39,  111 => 36,  107 => 35,  103 => 33,  99 => 32,  93 => 30,  90 => 29,  86 => 27,  84 => 26,  80 => 25,  77 => 24,  72 => 23,  70 => 21,  69 => 20,  68 => 19,  67 => 18,  57 => 11,  49 => 6,  42 => 1,);
    }
...
", "staffportal/StaffPortal.html", "/var/www/html/mounted/website/src/Views/staffportal/StaffPortal.html");
    }
}
