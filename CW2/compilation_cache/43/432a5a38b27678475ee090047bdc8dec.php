...
<body>
  ...
  ";
        ...
        if (($context["show"] ?? null)) {
            // line 22
            yield "  ";
            yield from $this->loadTemplate("/diner/diner-header.html", "diner/reservation.html", 22)->unwrap()->yield($context);
            // line 23
            yield "  ";
        } else {
            // line 24
...
<script src=\"/public/js/diner/reservation.js\"></script>";
        yield from [];
    }
...
<script src=\"/public/js/diner/reservation.js\"></script>", "diner/reservation.html", "/var/www/html/mounted/website/src/Views/diner/reservation.html");
    }
}
