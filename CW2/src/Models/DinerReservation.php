...
class DinerReservation
{
    ...
    //get list of reservations for a diner by date 
    ...
    //fetch the reservation times available for a service by date
    ...
    //get the next servcice booking avaialbe used for staff services
