...
class DinerLoginController extends Controller
{
    public function index()
    {
        ...
        $this->render('/diner/diner-login', $data);
    }

    // Register page for diner
    public function register()
    {

        $data["pagetitle"] = 'Lancaster - Register';

        $this->render('/diner/diner-signup', $data);
    }

    // Change password page for diner
    public function changePasswordPage(){
        ...
        $this->render('/diner/update-password', $data);

    }
    // Send OTP to diner using their email
    ...
    // Update the password of the diner
