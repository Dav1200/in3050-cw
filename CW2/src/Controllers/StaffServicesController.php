...
class StaffServicesController extends StaffRedirectController
{
    public function index()
    {
        ...
        $this->render('staffportal/manage-service', $data);
    }
    ...
    public function addService()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            // retrieve form inputs and sanitise them
